  ...
  return (
    <footer className="relative w-full pt-16 flex flex-col items-center bg-[#153D1C] text-white">
      ...
      <div className="w-full flex flex-col items-center mb-12 px-8">
        ...
        <address className="not-italic">
          ...
          <p className="text-[16px] text-center text-white font-[500] leading-[1.7] mb-6">
            WhatsApp : <a href="https://wa.me/237690536012" rel="noopener noreferrer" target="_blank" className="hover:text-[#ccff00] transition-colors">+237 690 53 60 12</a>
          </p>
      ...
      <div className="w-full grid grid-cols-2 gap-x-8 mb-12 px-10">
        ...
        <div className="flex flex-col gap-3">
          <div className="mb-2">
            <h4 className="text-[17px] font-[600] text-white pb-2 border-b-2 border-white/40 inline-block">Ressources</h4>
          </div>
          <a href="/guide" className="text-[15px] text-white/80 hover:text-[#ccff00] transition-colors">Guide Marketing</a>
